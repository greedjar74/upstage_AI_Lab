...
df = pd.read_csv("/data/ephemeral/home/data/test.csv")  # Replace "train.csv" with your actual file path
...
df.to_csv("test_translated.csv", index=False)  # Saves the new CSV with the translations
print("완료")
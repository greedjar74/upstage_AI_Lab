...
url_list = ['https://1xbet.whoscored.com/Regions/252/Tournaments/2/Seasons/9075/England-Premier-League',
            'https://1xbet.whoscored.com/Regions/252/Tournaments/2/Seasons/8618/England-Premier-League',
            'https://1xbet.whoscored.com/Regions/252/Tournaments/2/Seasons/8228/England-Premier-League',
            'https://1xbet.whoscored.com/Regions/252/Tournaments/2/Seasons/7811/England-Premier-League',
            'https://1xbet.whoscored.com/Regions/252/Tournaments/2/Seasons/7361/England-Premier-League']

year_list = ['22_23', '21_22', '20_21', '19_20', '18_19']
id_list = ['20934', '19793', '18685', '17590', '16368']
for i in range(5):
    url = url_list[i]
    year = year_list[i]
    ...
    team_df.to_csv(f'{year}_EPL_Team_Table.csv', encoding='utf-8-sig')
    print(team_df.tail())
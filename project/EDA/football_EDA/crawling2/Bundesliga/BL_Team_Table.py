...
url_list = ['https://1xbet.whoscored.com/Regions/81/Tournaments/3/Seasons/9120/Germany-Bundesliga',
            'https://1xbet.whoscored.com/Regions/81/Tournaments/3/Seasons/8667/Germany-Bundesliga',
            'https://1xbet.whoscored.com/Regions/81/Tournaments/3/Seasons/8279/Germany-Bundesliga',
            'https://1xbet.whoscored.com/Regions/81/Tournaments/3/Seasons/7872/Germany-Bundesliga',
            'https://1xbet.whoscored.com/Regions/81/Tournaments/3/Seasons/7405/Germany-Bundesliga']

year_list = ['22_23', '21_22', '20_21', '19_20', '18_19']
id_list = ['21026', '19862', '18762', '17682', '16427']
for i in range(5):
    url = url_list[i]
    year = year_list[i]
    ...
    team_df.to_csv(f'{year}_BL_Team_Table.csv', encoding='utf-8-sig')
    print(team_df.tail())
...
url_list = ['https://1xbet.whoscored.com/Regions/108/Tournaments/5/Seasons/9159/Stages/21087/Show/Italy-Serie-A-2022-2023',
            'https://1xbet.whoscored.com/Regions/108/Tournaments/5/Seasons/8735/Italy-Serie-A',
            'https://1xbet.whoscored.com/Regions/108/Tournaments/5/Seasons/8330/Italy-Serie-A',
            'https://1xbet.whoscored.com/Regions/108/Tournaments/5/Seasons/7928/Italy-Serie-A',
            'https://1xbet.whoscored.com/Regions/108/Tournaments/5/Seasons/7468/Italy-Serie-A']

year_list = ['22_23', '21_22', '20_21', '19_20', '18_19']
id_list = ['21087', '19982', '18873', '17835', '16548']
for i in range(5):
    url = url_list[i]
    year = year_list[i]
    ...
    team_df.to_csv(f'{year}_SA_Team_Table.csv', encoding='utf-8-sig')
    print(team_df.tail())
...
url_list = ['https://1xbet.whoscored.com/Regions/206/Tournaments/4/Seasons/9149/Spain-LaLiga',
            ...
            'https://1xbet.whoscored.com/Regions/206/Tournaments/4/Seasons/8321/Spain-LaLiga',
            'https://1xbet.whoscored.com/Regions/206/Tournaments/4/Seasons/7889/Spain-LaLiga',
            'https://1xbet.whoscored.com/Regions/206/Tournaments/4/Seasons/7466/Spain-LaLiga']

year_list = ['22_23', '21_22', '20_21', '19_20', '18_19']
id_list = ['21073', '19895', '18851', '17702', '16546']
for i in range(5):
    url = url_list[i]
    year = year_list[i]
    ...
    team_df.to_csv(f'{year}_LL_Team_Table.csv', encoding='utf-8-sig')
    print(team_df.tail())